# References - WHO SMART Guidelines - HIV v0.4.4
...
For additional resources, see the [Dependencies](dependencies.md) page, which includes the standards referenced in this implementation guide and the references section in the published DAK for HIV.
