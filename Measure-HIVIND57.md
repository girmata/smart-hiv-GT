...
* Knowledge Artifact Metadata: Numerator
  * ?: **ID**: HIV.IND.57.NUM**Description**:Number of people enrolled in a DSD ART model with at least one routine viral load test during the reporting period who have virological suppression (<1000 copies/mL) at 6 months after ART initiation and yearly thereafter (that is, at 24, 36, 48 and 60 months, etc. after ART initiation).**Logic Definition**:[Numerator](#hivind57logic-numerator)
